...
function set(value) {
    ...
    var createMonsterElement = function (monster) {
        ...
        img.src = 'http://servjc.vocalis-ensemble.com/dqm/monsters/' + monster.index + '.png';
        div.appendChild(img);
